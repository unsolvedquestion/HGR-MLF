...
# naive graph convolutional networks  朴素图卷积神经网络
class GraphConv(nn.Module):
	...
	def forward(self, inputs,edge_inputs, adjacency_matrix):  #自动调用
		'''
...
class GCGCN_glove(nn.Module):
	def __init__(self, config):
		...
		self.sentence_attention = nn.ModuleList([SentenceAttention (hidden_size,hidden_size) for _ in range(self.config.graph_hop)])   #元路径
